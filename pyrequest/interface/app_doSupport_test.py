...
class appDoSupportTest(unittest.TestCase):
    '''调用点赞接口'''

    def setUp(self):
        self.base_url = "https://app-uat.maxxipoint.com/api/newProduct/doSupport"

    def tearDown(self):
        print(self.result)
        # pass

    def test_app_support(self):
        ...
        self.result = r.json()
        print(self.result)
        self.assertEqual(self.result['data'], '{"respCode":"00","respMsg":"成功","bizData":'
                                              '"{\\"supportNum\\":\\"101\\"}",'
